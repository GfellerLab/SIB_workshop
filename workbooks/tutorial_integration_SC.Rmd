...
tf <- read.table("../../../Documents/testScenic/auxData/transcription.factor.activity.GO0003700.symbol.list")
...
```
```{r}
FeatureScatter(object = pbmc[,pbmc$majorType %in% c("NK","CD8")], feature1 = "JUN", feature2 = 'CCL4',group.by = "majorType")

FeatureScatter(object = seuratSC[,seuratSC$majorType %in% c("NK","CD8")], feature1 = "JUN", feature2 = 'CCL4',group.by = "majorType",)
```
